...
import { getDiscordGuild } from '@/utils/discord/guilds/DiscordGuildsApi'
import { getDiscordGuildSubscriptions } from '@/utils/discord/guilds/DiscordSubscriptionApi'
...
<template>
    <NuxtLayout>
        <div class="container">
            ...
            <NuxtLink :to="`/dashboard/guild/${discordGuild.id}/channel/add`" class="btn btn-primary">
                {{ t('add-channel') }}
            </NuxtLink>
            <div :class="$style.channels">
                <div v-for="subscription in subscriptions" :key="subscription.id" class="card card-default">
                    <div class="card-body">
